...
package net.mcreator.levelup.world.inventory;

import net.mcreator.levelup.LevelUpMod;

public class AntimatterFurnaceGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public AntimatterFurnaceGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(LevelUpModMenus.ANTIMATTER_FURNACE_GUI.get(), id);
